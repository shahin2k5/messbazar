        ...
        <div class="row">
          ...
          <section class="col-lg-12 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form action="/products/post-categories" method="post" enctype="multipart/form-data">
				    @csrf
					...
					<tr>
						...
						<td><input type="text" name="category_title" required placeholder="Enter Category Title" class="form-control"></td>
					</tr>
					<tr>
