			 ...
			 <ImageBackground source={require('../assets/images/LoginScreen/login_bg.png')} style={styles.backgroundImage}>
				  ...
				  <List style={{marginTop:80, paddingLeft:30}}>
					...
					<ListItem style={styles.lineItem}>
						...
						<Input placeholder="বাসার নাম" onChangeText={house_mess_name=>{this.setState({house_mess_name})}} style={{fontSize:15}} />
					</ListItem>
					
						<ListItem style={styles.lineItem}>
						<Icon type={"FontAwesome"} active name='arrow-circle-left' size={5} style={{height:27,width:27,marginLeft:5}} />
						<Input placeholder="ব্যবহারকারীর নাম" onChangeText={user_full_name=>{this.setState({user_full_name})}} style={{fontSize:15}} />
					</ListItem>
					
				 
					<ListItem style={styles.lineItem }>
						<Icon type={"FontAwesome"} active name='arrow-circle-left' size={5} style={{height:27,width:27,marginLeft:5}} />
						<Input placeholder="মোবাইল"  onChangeText={user_mobile=>{this.setState({user_mobile})}}  style={{fontSize:15}} />
					</ListItem>
					...
					<ListItem style={ styles.lineItem}>
						<Icon type={"FontAwesome"} active name='arrow-circle-left' size={5} style={{height:27,width:27,marginLeft:5}} />
						<Input placeholder="বাসার ঠিকানা"   onChangeText={full_address=>{this.setState({full_address})}}   style={{fontSize:15}} />
					</ListItem>
...
export default HomeUserRegistrationScreen;