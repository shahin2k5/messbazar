...
class PrepareCartListScreen extends Component {
  ...
  render() {
    return (
      <Container>
			<HeaderScreen navigation={this.props.navigation}  total_price={this.props.cartList?this.props.cartList.total_final_price:'0.00'}   title={"বাজার/কার্ট লিস্ট তৈরী"} />
				...
				backgroundColor:'#93FC87'
						...
						<FooterTab>
							<Button  onPress={()=>{this.props.navigation.navigate('Category')}} style={{backgroundColor:'#009933',color:'#fff'}}>
							  ...
							  <Text  style={{color:'#fff'}}>ক্যাটাগরি</Text>
							</Button>
						</FooterTab>	
						<FooterTab>
